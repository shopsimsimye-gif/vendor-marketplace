...
// ── جلب السحوبات عبر Repository (بدلاً من SQL المباشر في القالب) ──
$withdrawal_repo = \VMP\Core\Container::getInstance()->make(\VMP\Contracts\WithdrawalRepositoryInterface::class);

$paged  = max(1, (int) get_query_var('paged', 1));
$limit  = 15;
$offset = ($paged - 1) * $limit;

$withdrawals = $withdrawal_repo->getByVendor($vendor_id, [
    'limit'  => $limit,
    'offset' => $offset,
    'status' => '',
]);
$total = $withdrawal_repo->countByVendor($vendor_id);
