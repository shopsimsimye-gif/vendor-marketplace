 ...
 */
/**
 * @deprecated [QA 2026-08-02] هذا المتحكم لم يعد مستخدماً — تم تعطيل مسارات
 * التسجيل متعددة الخطوات (AJAX) في CoreServiceProvider (2026-08-02).
 * بديله: VMP\Controllers\VendorRegistrationController (AJAX) و
 * VMP\Controllers\RestVendorRegistrationController (REST).
 * يُحتفظ به مؤقتاً لإمكانية إعادة تفعيل المسارات لاحقاً — لا تحذفه.
 */
