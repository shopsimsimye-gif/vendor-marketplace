...
class CronServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // ملاحظة: لا نسجّل wp_ajax_nopriv — الزوار لا يجب أن يشغّلوا الطابور.
    ...
    public function handleRunQueueAjax(): void
    {
        ...
        // التحقق من صلاحية المستخدم — المسار متاح فقط للمشرفين (أو من يملك vmp_manage_settings)
        if (!current_user_can('vmp_manage_settings')) {
            wp_send_json_error(['message' => __('غير مصرح لك.', 'vmp')], 403);
        }
