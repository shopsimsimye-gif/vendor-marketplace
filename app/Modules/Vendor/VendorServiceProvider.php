...
class VendorServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // [QA 2026-08-02] مُعطَّل: routes قديمة متعددة الخطوات (مكسورة: namespace خاطئ + methods غير موجودة) ولا يستخدمها القالب
        // add_action('rest_api_init', [$this, 'registerRestRoutes']);
        
        // إضافة نص برمجي (script) ونمط (style) للصفحة
        // [QA 2026-08-02] مُعطَّل: assets خاصة بالصفحة القديمة متعددة الخطوات فقط
        // add_action('wp_enqueue_scripts', [$this, 'enqueueAssets']);
        
        // معالجات AJAX
        // [QA 2026-08-02] مُعطَّل: معالجات AJAX القديمة متعددة الخطوات (methods غير موجودة في VendorRegistrationController)
